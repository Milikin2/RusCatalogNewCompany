 ...
 */
    ...
    (() => {
        ...
        modules_flsModules.tippy = tippy_esm("[data-tippy-content__applicationQuality]", {
            placement: "right",
            content: "Юридическое название вашей организации",
            arrow: false,
            maxWidth: 228
        });
        ...
        function initSliders() {
            ...
            if (document.querySelector(".list__swiper")) new core(".list__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".swiper-button-prev__comp",
                    nextEl: ".swiper-button-next__comp"
                },
                on: {}
            });
        ...
        da.init();
        const entityInputInn = document.querySelector(".entity__input-inn");
        const entityInputOgrn = document.querySelector(".entity__input-ogrn");
        const formContactsTelephone = document.querySelector(".contacts__form-telephone-input");
        let telMask = new Inputmask("+7 999 99 99 999");
        let entityInputInnMask = new Inputmask("9999999999");
        let entityInputOgrnMask = new Inputmask("999999999999");
        entityInputOgrnMask.mask(entityInputOgrn);
        entityInputInnMask.mask(entityInputInn);
        telMask.mask(formContactsTelephone);
        window["FLS"] = true;
        isWebp();
        menuInit();
        formFieldsInit({
